...
convenience init() {
    ...
    func calculate (resultValue: @escaping (PriceModel) -> ()) {
        var priceModel = PriceModel(weight: "0.00", weightRate: "0.00", startingPrice: "0.00", transactionPrice: "0.00", transactionRatePrice: "0.00", kitStopPrice: "0.00", finalPrice: "0.00")
